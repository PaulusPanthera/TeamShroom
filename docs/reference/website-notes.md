...
- Reference screenshots are in docs/reference/websiteexamples/ (filenames describe the page). Use them for visual validation only. Do not edit or rename them.
