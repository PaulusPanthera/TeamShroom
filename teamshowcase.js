...
const teamShowcase = [
  ...
  { name: "maknaez", shinies: [
    ...
    { name: "solrock" }, { name: "dugtrio" }, { name: "onix" }
  ] },
  ...
  { name: "PaulusTFT", shinies: [
    ...
    { name: "paras" }, { name: "voltorb" }, { name: "weezing" }, { name: "gligar" }, { name: "amoonguss" }, { name: "koffing" }, { name: "golett" }, { name: "stunky" }
  ] },
